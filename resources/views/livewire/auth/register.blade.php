<div class="container mx-auto">
  <div class="w-full max-w-xs mx-auto py-8">
    <h1 class="mb-4 font-semibold text-4xl text-center">Register for Quizy</h1>
    ...
    <a href="/login" class="inline-block float-right mt-4 text-sm font-semibold text-blue-500 hover:underline">Login to Quizy</a>
  </div>
</div>
